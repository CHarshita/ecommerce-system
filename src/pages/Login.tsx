  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-bg particles px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/6 w-16 h-16 bg-primary/8 rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <Card className="w-full max-w-md gradient-card animate-scale-in border-primary/20 shadow-2xl animate-glow relative z-10">
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2 animate-slide-up-delay-1">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className={`pl-10 input-focus transition-all duration-300 hover:border-primary/50 focus:border-primary ${errors.email ? "border-destructive animate-pulse" : ""}`}
                  disabled={isLoading}
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-2 animate-slide-up-delay-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  className={`pl-10 pr-10 input-focus transition-all duration-300 hover:border-primary/50 focus:border-primary ${errors.password ? "border-destructive animate-pulse" : ""}`}
                  disabled={isLoading}
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between animate-slide-up-delay-3">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="rememberMe" className="text-sm cursor-pointer hover:text-primary transition-colors">
                  Remember me
                </Label>
              </div>
              <Link
                to="/forgot-password"
                className="text-sm text-primary hover:text-primary-hover transition-all duration-300 hover:underline font-medium"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full button-hover bg-gradient-to-r from-primary to-primary-hover text-primary-foreground font-semibold py-3 text-base animate-slide-up-delay-4 relative overflow-hidden"
              disabled={isLoading}
            >
              {isLoading ? (
                ...
                <>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-hover to-primary opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
                </>
              )}
            </Button>
            ...
            <div className="grid grid-cols-2 gap-4 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <Button 
                ...
                type="button" 
                disabled={isLoading}
                className="button-hover border-primary/20 hover:border-primary/50 hover:bg-primary/5"
              >
            ...
            <div className="text-center text-sm text-muted-foreground animate-fade-in" style={{ animationDelay: '0.7s' }}>
              ...
              <Link
                to="/signup"
                className="text-primary hover:text-primary-hover font-semibold transition-all duration-300 hover:underline"
              >
                Sign up for free
              </Link>
            </div>
